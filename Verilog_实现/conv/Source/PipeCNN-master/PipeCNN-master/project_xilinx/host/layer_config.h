...
unsigned input_config[5] = {3, 3, 4, 1}; //original image size(dim1, dim2, dim3), batch size
unsigned output_config[3] = {1, 1, 4};//Layer-8  Note: only one result is extracted and verified
#endif
...
char precision_config[][3] ={{(char) 4, (char) 0, (char) 1}};//Layer-1
unsigned input_config[5] = {3, 3, 4, 1}; //original image size(dim1, dim2, dim3), batch size
unsigned output_config[3] = {1, 1, 4};//Layer-8  Note: only one result is extracted and verified
#endif
